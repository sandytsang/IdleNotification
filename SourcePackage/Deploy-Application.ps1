...
Try {
	...
	[string]$appVendor = 'Sandy'
	[string]$appName = 'IdleNotification'
	[string]$appVersion = '2.0.0'
	[string]$appArch = ''
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.1'
	[string]$appScriptDate = '18/10/2020'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		## <Perform Installation tasks here>
            Execute-Process -Path C:\Windows\System32\Robocopy.exe -Parameters "`"$dirFiles\IdleNotification`" `"C:\Program Files\IdleNotification`" /mir /r:0 /w:0" -IgnoreExitCodes 1
